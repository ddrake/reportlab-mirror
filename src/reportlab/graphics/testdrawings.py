...
from reportlab.graphics.shapes import (Drawing, Line, Circle, Wedge, PolyLine,
                                       Polygon, Ellipse, Rect, String)
...
#     C = (colors.black,colors.red,colors.green,colors.blue,
#          colors.brown,colors.gray, colors.pink,
#          colors.lavender,colors.lime, colors.mediumblue,
#          colors.magenta, colors.limegreen)
#
#     for i in range(12):
#         D.add(String(0, 0, ' - - Rotated Text', fill=C[i%len(C)],
#               transform=mmult(xform, rotate(30*i))))
#
#     return D
#
# def getDrawing7():
...
#     C = (colors.black,colors.red,colors.green,colors.blue,colors.brown,
#          colors.gray, colors.pink, colors.lavender,colors.lime, colors.mediumblue,
#          colors.magenta, colors.limegreen)
#     p = Path(50,50)
#     p.lineTo(100,100)
#     p.moveBy(-25,25)
...
#     D.add(p)
#     D.add(String(10,30,
#           'Tests of path elements-lines and bezier curves-and text formating'))

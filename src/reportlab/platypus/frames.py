...
_geomAttr = ('x1', 'y1', 'width', 'height', 'leftPadding', 'bottomPadding',
        ...
        try:
            ...
            if y < p-_FUZZ:
                if (not rl_config.allowTableBoundsErrors and
                    ...
                    raise LayoutError(
                        ("Flowable %s (%sx%s points) too " +
                         "large for frame (%sx%s points).") %
                ...
                if fbg and fbg[-1].active:
                    ...
                    if not bgm:
                        ...
                        if (bgm == 'frame' or bgm == 'frame-permanent' or
                                (att and bgm == 'frame-permanent-1')):

...
class TocTestCase(unittest.TestCase):
    ...
    def test0(self):
        ...
        def doTest(rLPN=False):
            ...
            path = outputfile('test_platypus_toc%s.pdf' %
                              ('_page_x_of_y' if rLPN else ''))
    ...
    def test1(self):
        ...
        for i in range(chapters):
            ...
            title = (('This is chapter %d' %
                      (i+1)) if i != 9 else
                     '<a href="http://www.reportlab.com">onelink</a>')
            ...
            def draw(self):
                ...
                for i in range(chapters):
                    ...
                    self.canv.linkRect(
                        ...
                        thickness=0.5, color=pink, relative=0)

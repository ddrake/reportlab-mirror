    ...
    def makeBackground(self):
        if self.background is not None:
            ...
            strokeColor, strokeWidth, (
                fillColor) = self.strokeColor, self.strokeWidth, self.fillColor
            if (strokeWidth and strokeColor) or fillColor:
                ...
                if _3d_dy is not None:
                    ...
                    if fillColor or strokeColor or c:
                        bg = Polygon(
                            [x, y, x, y+h, x+_3d_dx, y+h+_3d_dy, x+w+_3d_dx,
                             y+h+_3d_dy, x+w+_3d_dx, y+_3d_dy, x+w, y],
                            strokeColor=strokeColor or c or grey,
                            strokeWidth=strokeWidth, fillColor=fillColor)
                        g.add(bg)
                        g.add(Line(x, y, x+_3d_dx, y+_3d_dy, strokeWidth=0.5,
                                   strokeColor=c))
                        g.add(Line(x+_3d_dx, y+_3d_dy,  x+_3d_dx, y+h+_3d_dy,
                                   strokeWidth=0.5, strokeColor=c))
                        ...
                        bg = Line(x+_3d_dx, y+_3d_dy, x+w+_3d_dx, y+_3d_dy,
                                  strokeWidth=0.5, strokeColor=c)
                    else:
                        bg = None
                else:

...
class IssueTestCase(unittest.TestCase):
    def test_issue183(self):
        ...
        aW = 440
        text = u'''AAAAAAAAAAAA BBBBB C Dddd EEEEEEEE\xa0\u2014 FF GGGGGG HHHHHHHHH
        III JJJJJJJJJ KKK LLLLLLLLL MMMMMM NNNNN O PPPPPP Q RRRRR SSSSSS TTTTTTTTTTT.
        UUUUUUU VVVVVVVV WWWWWWWWWWWW XXX YYYYYY ABBBBB BCCCCCCCCCCC.'''
        ...
        for fontName in 'Helvetica Vera TTFTimes'.split():
            ...
            for ws in 0, -1, 1:
                for s in (u' ', u'\xa0'):
                    ...
                    lab = '%-9s ws=%2d %s:' % (
                        fontName, ws, s == u' ' and 'soft' or 'hard')
                    if offs is None:

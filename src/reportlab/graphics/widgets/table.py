...
from reportlab.lib.validators import (isNumber, isColorOrNone, isBoxAnchor, isString,
                                      isListOfNumbersOrNone, OneOf)
...
class TableWidget(Widget):
    ...
    def __init__(self, x=10, y=10, **kw):
        ...
        self.data = [['North', 'South', 'East', 'West'],
                     [100, 110, 120, 130],
        ...
        for k, v in kw.items():
            if k in list(self.__class__._attrMap.keys()):
                ...
                raise ValueError('invalid argument supplied for class %s' %
                                 self.__class__)
    ...
    def draw(self):
        ...
        # data = self.preProcessData(self.data) (assigned but not used)
        rows = len(self.data)

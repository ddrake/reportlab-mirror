...
class LinkTestCase(unittest.TestCase):
    ...
    def test1(self):
        ...
        c.bookmarkPage("P1_FITR", fit="FitR", left=1*inch, bottom=2*inch,
                       right=5*inch, top=6*inch)
        c.addOutlineEntry("Page 1 FitR (left=1, bottom=2, right=5, top=6)",
                          "P1_FITR", level=1)
        ...
        # Note : This time left will be at 3*inch because the
        # zoom makes the page to big to fit
        ...
        c.bookmarkPage("P2_FITR", fit="FitR", left=1*inch, bottom=2*inch,
                       right=5*inch, top=6*inch)
        c.addOutlineEntry("Page 2 FitR (left=1, bottom=2, right=5, top=6)",
                          "P2_FITR", level=1)
        ...
        # Horizontal absolute test from page 1. Note that because of the
        # page size used on page 3 all this will do
        # is put the view centered on the bookmark. If you want to see it
        # "up close and personal" change page3 to be
        # the same page size as the other pages.
        c.saveState()
        c.setFont("Courier", 14)
        c.setFillColor(colors.green)
        c.drawString(2.5*inch, 2.5*inch, "This line is hyperlinked from page 1")
        # c.bookmarkHorizontalAbsolute("HYPER_1",3*inch)
        # slightly higher than the text otherwise text is of screen above.
        ...
        # Turn the page on its size and make it 2* the normal "width"
        # in order to have something to test FitV against.
        ...
        c.bookmarkPage("MOL", fit="FitR", left=4*inch, top=7*inch,
                       bottom=4*inch, right=6*inch)

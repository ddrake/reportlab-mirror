...
from reportlab.lib.validators import (isNoneOrListOfNoneOrStrings, isString, isNumber,
                                      isColor)
...
class DotBox(Widget):
    ...
    def draw(self):
        ...
        # box
        g.add(Rect(self.x, self.y, len(self.xlabels)*self.gridDivWidth,

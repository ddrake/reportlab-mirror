...
class CHTFontTests(unittest.TestCase):
    ...
    def test0(self):
        ...
        # tx.textLines("""
        #     This test document shows Traditional Chinese output
        #     from Reportlab PDF Library.
        ...
        #     encodings_cht = [
        #         'B5pc-H',           # Macintosh, Big Five character set,
        #                             # Big Five encoding,
        #                             # Script Manager code 2
        #         'B5pc-V',           # Vertical version of B5pc-H
        #         'ETen-B5-H',        # Microsoft Code Page 950 (lfCharSet 0x88),
        #                             # Big Five
        #                             # character set with ETen extensions
        #         'ETen-B5-V',        # Vertical version of ETen-B5-H
        #         'ETenms-B5-H',      # Microsoft Code Page 950 (lfCharSet 0x88),
        #                             # Big Five
        #                             # character set with ETen extensions;
        ...
        #     The next 32 pages show the complete character set available in
        #     the encoding "ETen-B5-H".  This is Big5 with the ETen extensions.
        #     ETen extensions are the most common extension to Big5 and include
        #     circled and roman numbers, Japanese hiragana and katakana, Cyrillic
        #     and fractions in rows C6-C8; and 7 extra characters

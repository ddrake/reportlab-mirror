...
class RenderPSSimpleTestCase(unittest.TestCase):
    ...
    def test5(self):
        ...
        d = Drawing(1, 1)
        self.assertTrue(isStr(renderPS.drawToString(d)),
                        msg='renderPS.draweToString should return bytes')
    ...
    <body>
        ...
        The first 3 have a native size of 400x200, thus consume a
        height of 200 pixels on

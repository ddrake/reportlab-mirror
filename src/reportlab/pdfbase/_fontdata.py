...
from reportlab.rl_config import T1SearchPath  # noqa
from reportlab.lib.utils import rl_isfile     # noqa
...
standardEncodings = ('WinAnsiEncoding', 'MacRomanEncoding', 'StandardEncoding',
                     'SymbolEncoding', 'ZapfDingbatsEncoding', 'PDFDocEncoding',
                     'MacExpertEncoding')
...
class _Name2StandardEncodingMap(dict):
    ...
    _XMap = {'winansi': 'WinAnsiEncoding', 'macroman': 'MacRomanEncoding',
             'standard': 'StandardEncoding', 'symbol': 'SymbolEncoding',
             'zapfdingbats': 'ZapfDingbatsEncoding', 'pdfdoc': 'PDFDocEncoding',

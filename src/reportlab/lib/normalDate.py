...
"""Jeff Bauer's lightweight date class, extended by us.
Predates Python's datetime module."""
...
if __name__ == '__main__':
    ...
    print("  Today (%s) is: %s %s" % (today, today.dayOfWeekAbbrev(),
                                      today.localeFormat()))
    yesterday = today - 1
    print("  Yesterday was: %s %s" % (yesterday.dayOfWeekAbbrev(),
                                      yesterday.localeFormat()))
    tomorrow = today + 1
    print("  Tomorrow will be: %s %s" % (tomorrow.dayOfWeekAbbrev(),
                                         tomorrow.localeFormat()))

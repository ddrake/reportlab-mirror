...
def _draw_3d_bar(G, x1, x2, y0, yhigh, xdepth, ydepth,
    ...
    def _add_3d_bar(x1, x2, y1, y2, xoff, yoff, G=G, strokeColor=strokeColor,
    ...
    if xdepth or ydepth:
        G.add(Line(x1, usd, x2, usd, strokeWidth=strokeWidth,
...
def _make_3d_line_info(G, x0, x1, y0, y1, z0, z1,
    ...
    c = (slope > depth_slope and
         _getShaded(fillColor, fillColorShaded, shading) or fillColor)
    zy0 = z0*theta_y
    zx0 = z0*theta_x
...
if __name__ == '__main__':
    ...
    print(find_intersections([
        ...
        [(.2666666667, 0.4), (0.1, 0.4), (0.1, 0.2), (0, 0), (1, 1)],
        [(0, 1), (0.4, 0.1), (1, 0.1)]]))
    print(find_intersections([
        [(0.1, 0.2), (0.1, 0.4)],
        [(0, 1), (0.4, 0.1)]]))
